...
<head>
    <title>Chinese Anime on <?=$websiteTitle?></title>
    
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="Chinese Anime on <?=$websiteTitle?>">
    <meta name="description" content="Chinese Anime on <?=$websiteTitle?> in HD with No Ads. Watch anime online">
    ...
    <meta property="og:title" content="Chinese Anime on <?=$websiteTitle?>">
    <meta property="og:description" content="Chinese Anime on <?=$websiteTitle?> in HD with No Ads. Watch anime online">
                    ...
                    <section class="block_area block_area_category">
                        <div class="block_area-header">
                            <div class="float-left bah-heading mr-4">
                                <h2 class="cat-heading">Chinese Anime</h2>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <div class="tab-content">
                            <div class="block_area-content block_area-list film_list film_list-grid film_list-wfeature">
                                ...
                                <?php 
                                // Get data from Anilist API - specifically Chinese anime
                                $result = get_chinese_anime($page);
                                
                                if (isset($result['data']) && isset($result['data']['Page']) && isset($result['data']['Page']['media'])) {
                                    $animeList = $result['data']['Page']['media'];
                                    
                                    foreach ($animeList as $anime) {
                                        // Get the title (prefer English, fallback to romaji, then native for Chinese titles)
                                        if (!empty($anime['title']['english'])) {
                                            $title = $anime['title']['english'];
                                        } elseif (!empty($anime['title']['romaji'])) {
                                            $title = $anime['title']['romaji'];
                                        } else {
                                            $title = $anime['title']['native'];
                                        }
                                        
                                        // Get the current episode number or total episodes
                                        ...
                                        $episodeId = $anime['id'] . '-chinese-episode-' . $episodeNum;
                                ...
                                ?>
                                    <div class="flw-item">
                                        ...
                                        <div class="tick ltr">
                                                <div class="tick-item-chi tick-eps amp-algn">Chinese</div>
                                            </div>
                                            <div class="tick rtl">
                                            ...
                                            <a class="film-poster-ahref"
                                                ...
                                                title="<?=$title?> Episode <?=$episodeNum?> (Chinese)"
                                    ...
                                    <nav>
                                        ...
                                        <?php 
                                           if (isset($result['data']) && isset($result['data']['Page']) && isset($result['data']['Page']['pageInfo'])) {
                                               ...
                                               echo format_pagination($pageInfo, '/latest/chinese');
                                           }
                                        ?>
                                        </ul>
                                    </nav>
