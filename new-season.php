                    ...
                    <section class="block_area block_area_category">
                        ...
                        <div class="tab-content">
                            <div class="block_area-content block_area-list film_list film_list-grid film_list-wfeature">
                                ...
                                $current_season_index = floor(($current_month - 1) / 3);
                                $current_season = $seasons[$current_season_index];
                                $year = date('Y');
                                
                                // Season query with current season and year
                                $query = '
                                ...
                                <?php 
                                    ...
                                    echo '<div class="alert alert-warning">No current season anime found.</div>';
                                }
                                ?>                                
                                ...
                                <div class="pagination">
                                    <nav>
                                        ...
                                        <?php 
                                            ...
                                            if (isset($pageInfo)) {
                                                $currentUrl = $websiteUrl.'/new-season';
