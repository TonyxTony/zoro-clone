...
<head>
    <title>Trending Anime on <?=$websiteTitle?></title>
    
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="Trending Anime on <?=$websiteTitle?>">
    <meta name="description" content="Trending Anime in HD with No Ads. Watch anime online">
    ...
    <meta property="og:title" content="Trending Anime on <?=$websiteTitle?>">
    <meta property="og:description" content="Trending Anime on <?=$websiteTitle?> in HD with No Ads. Watch anime online">
                    ...
                    <section class="block_area block_area_category">
                        ...
                        <div class="tab-content">
                            <div class="block_area-content block_area-list film_list film_list-grid film_list-wfeature">
                                ...
                                $result = get_trending_anime(intval($page), 20);
                                    ...
                                    <div class="flw-item">
                                        <div class="film-poster">
                                            ...
                                            <div class="tick rtl">
                                                ...
                                                <?php endif; ?>
                                                <?php if (isset($anime['trending_rank'])): ?>
                                                <div class="tick-item tick-trending">#<?=$anime['trending_rank']?></div>
                                                <?php endif; ?>
                                            </div>
                                ...
                                <?php 
                                    ...
                                    echo '<div class="alert alert-warning">No trending anime found.</div>';
                                }
                                ?>                                
                                ...
                                <div class="pagination">
                                    <nav>
                                        ...
                                        <?php 
                                           ...
                                           if (isset($pageInfo)) {
                                               $currentUrl = $websiteUrl.'/trending';
