                    ...
                    <section class="block_area block_area_category">
                        ...
                        <div class="tab-content">
                            <div class="block_area-content block_area-list film_list film_list-grid film_list-wfeature">
                                ...
                                <?php 
                                // Get anime movies from AniList API - filtering for MOVIE format
                                $perPage = 20;
                                $query = '
                                ...
                                $movies = $response['data']['Page']['media'];
                                $pageInfo = $response['data']['Page']['pageInfo'];
                                
                                foreach($movies as $movie) { 
                                    $title = !empty($movie['title']['english']) ? $movie['title']['english'] : $movie['title']['romaji'];
                                    $isDub = false; // AniList doesn't directly provide dub info
                                    $imgUrl = $movie['coverImage']['large'];
                                    $animeId = $movie['id'];
                                    $status = $movie['status'];
                                ...
                                <div class="pagination">
                                    <nav>
                                        ...
                                        <?php 
                                           ...
                                           echo format_pagination($pageInfo, '/type/movies.php');
                                        ?>
                                        </ul>
                                    </nav>
                                </div>
