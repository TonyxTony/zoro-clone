                    ...
                    <section class="block_area block_area_category">
                        ...
                        <div class="tab-content">
                            <div class="block_area-content block_area-list film_list film_list-grid film_list-wfeature">
                                ...
                                <?php 
                                // Get popular TV series from AniList API - filtering for TV format
                                $perPage = 20;
                                $query = '
                                ...
                                $tvSeries = $response['data']['Page']['media'];
                                $pageInfo = $response['data']['Page']['pageInfo'];
                                
                                foreach($tvSeries as $series) { 
                                    $title = !empty($series['title']['english']) ? $series['title']['english'] : $series['title']['romaji'];
                                    $isDub = false; // AniList doesn't directly provide dub info
                                    $imgUrl = $series['coverImage']['large'];
                                    $animeId = $series['id'];
                                ...
                                <div class="pagination">
                                    <nav>
                                        ...
                                        <?php 
                                           ...
                                           echo format_pagination($pageInfo, '/type/tv-series.php');
                                        ?>
                                        </ul>
                                    </nav>
                                </div>
