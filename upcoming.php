...
<head>
    <title>Upcoming Anime on <?=$websiteTitle?></title>
    
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="Upcoming Anime on <?=$websiteTitle?>">
    <meta name="description" content="Upcoming Anime in HD with No Ads. Watch anime online">
    ...
    <meta property="og:title" content="Upcoming Anime on <?=$websiteTitle?>">
    <meta property="og:description" content="Upcoming Anime on <?=$websiteTitle?> in HD with No Ads. Watch anime online">
                    ...
                    <section class="block_area block_area_category">
                        <div class="block_area-header">
                            <div class="float-left bah-heading mr-4">
                                <h2 class="cat-heading">Upcoming Anime</h2>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <div class="tab-content">
                            <div class="block_area-content block_area-list film_list film_list-grid film_list-wfeature">
                                ...
                                <?php 
                                // Get upcoming anime from Anilist API
                                $result = get_upcoming_anime(intval($page), 20);
                                ...
                                if (isset($result['data']) && isset($result['data']['Page']) && isset($result['data']['Page']['media'])) {
                                    ...
                                    foreach($animes as $anime) { 
                                        // Get title - use English title if available, otherwise use romaji
                                        $title = !empty($anime['title']['english']) ? $anime['title']['english'] : $anime['title']['romaji'];
                                        $isDub = false; // AniList doesn't provide dub info directly
                                    ...
                                    <div class="flw-item">
                                        <div class="film-poster">
                                            ...
                                            <div class="tick rtl">
                                                <?php if (isset($anime['format']) && !empty($anime['format'])): ?>
                                                <div class="tick-item tick-format"><?=$anime['format']?></div>
                                                <?php endif; ?>
                                            </div>
                                ...
                                <?php 
                                    ...
                                    echo '<div class="alert alert-warning">No upcoming anime found.</div>';
                                }
                                ?>                                
                                ...
                                <div class="pagination">
                                    <nav>
                                        ...
                                        <?php 
                                           ...
                                           if (isset($pageInfo)) {
                                               $currentUrl = $websiteUrl.'/upcoming';
